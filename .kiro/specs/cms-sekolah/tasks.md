...
- [x] 1. Inisialisasi proyek dan setup fondasi
  - [x] 1.1 Scaffold proyek Next.js 14 dengan App Router, install Tailwind CSS, dan inisialisasi shadcn/ui
  ...
  - [x] 1.2 Setup konfigurasi environment dan TypeScript types
...
- [x] 2. Database schema dan Prisma setup
  - [x] 2.1 Definisikan Prisma schema lengkap dengan semua model dan relasi
  ...
  - [x] 2.2 Buat Prisma client singleton dan jalankan migrasi awal
...
- [x] 3. Checkpoint — Pastikan database terhubung dan migrasi berhasil
  - Ensure all tests pass, ask the user if questions arise.

- [x] 4. Autentikasi dan middleware
  - [x] 4.1 Implementasi konfigurasi NextAuth.js v5 dengan Prisma adapter
  ...
  - [x] 4.2 Implementasi route guard middleware
  ...
  - [x] 4.3 Implementasi halaman login
...
- [x] 5. RBAC module dan permission system
  - [x] 5.1 Implementasi RBAC permission checker
  ...
  - [x] 5.3 Implementasi Zod validation schemas
...
- [x] 6. Checkpoint — Pastikan auth, RBAC, dan validasi berfungsi
  - Ensure all tests pass, ask the user if questions arise.

- [x] 7. Admin dashboard layout dan navigasi
  - [x] 7.1 Implementasi layout admin dengan sidebar dan header
  ...
  - [x] 7.2 Implementasi halaman dashboard overview
...
- [x] 8. Menu Builder module
  - [x] 8.1 Implementasi Server Actions untuk menu CRUD
  ...
  - [x] 8.2 Implementasi komponen Menu Builder dengan drag-and-drop
...
- [x] 9. Manajemen konten institusional
  - [x] 9.1 Implementasi Server Actions untuk konten institusional
  ...
  - [x] 9.2 Implementasi halaman manajemen konten institusional
...
- [x] 10. S3 upload service dan Image Uploader
  - [x] 10.1 Implementasi S3 client dan pre-signed URL service
  ...
  - [x] 10.2 Implementasi komponen Image Uploader
...
- [x] 11. Modul Berita dan Artikel
  - [x] 11.1 Implementasi Server Actions untuk artikel CRUD
  ...
  - [x] 11.2 Implementasi Tiptap rich-text editor component
  ...
  - [x] 11.3 Implementasi halaman admin berita (list + editor)
...
- [x] 12. Checkpoint — Pastikan semua modul admin berfungsi
  - Ensure all tests pass, ask the user if questions arise.

- [x] 13. Modul Galeri Foto
  - [x] 13.1 Implementasi Server Actions untuk galeri
  ...
  - [x] 13.2 Implementasi halaman admin galeri
...
- [ ] 14. Manajemen Data Guru dan Staf
  - [x] 14.1 Implementasi Server Actions untuk data guru
  ...
  - [x] 14.2 Implementasi halaman admin guru
...
- [x] 15. Manajemen Akun Staf (User Management)
  - [x] 15.1 Implementasi Server Actions untuk manajemen user
  ...
  - [x] 15.2 Implementasi halaman admin pengguna
...
- [x] 16. Checkpoint — Pastikan semua modul admin dan CRUD berfungsi
  - Ensure all tests pass, ask the user if questions arise.

- [x] 17. Landing page components (matching index4.html)
  - [x] 17.1 Implementasi layout publik dan Navbar
  ...
  - [x] 17.2 Implementasi Hero Section
  ...
  - [x] 17.3 Implementasi section Profil dan Berita Terbaru
  ...
  - [x] 17.4 Implementasi section Prakata Kepala Sekolah
  ...
  - [x] 17.5 Implementasi section Galeri Sekolah
  ...
  - [x] 17.6 Implementasi Staff Slider (Guru & Tenaga Kependidikan)
  ...
  - [x] 17.8 Implementasi halaman utama Landing Page (SSR)
  ...
  - [x] 17.9 Implementasi halaman detail berita dan daftar berita
...
- [x] 18. Property test untuk Route Guard
...
- [x] 19. Integration dan final wiring
  - [x] 19.1 Wire menu builder ke landing page navbar
  ...
  - [x] 19.2 Wire semua konten admin ke landing page
...
- [x] 20. Final checkpoint — Pastikan semua tests pass dan fitur terintegrasi
  - Ensure all tests pass, ask the user if questions arise.
